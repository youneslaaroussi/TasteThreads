        ...
        VStack(spacing: 16) {
            ...
            VStack(spacing: 12) {
                ...
                if let reservationId = action.reservationId {
                    DetailRow(icon: "number", label: "Confirmation", value: String(reservationId.prefix(8)).uppercased())
                }
            }
            ...
            HStack(spacing: 12) {
                ...
                // View on Yelp
                if let urlString = action.confirmationUrl, let url = URL(string: urlString) {
